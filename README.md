...
// Create a custom scale using an array of semitone intervals that sum to a multiple of 12.
let customScale = Scale(intervals: [2.4, 2.4, 2.4, 2.4, 2.4])

// Use ScaleCollection to create a collection of pitches from the given starting pitch and scale
